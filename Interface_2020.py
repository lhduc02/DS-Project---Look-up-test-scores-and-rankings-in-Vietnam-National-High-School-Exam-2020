    ...
    if sbd_str != "":
        ...
        if khoi != "":
            ...
            if math.isnan(diem_cua_thi_sinh):
                ...
                st.write("Điểm số của bạn tương đương với mức điểm", diem_tuong_duong(khoi, sort_toan_quoc.index(diem_cua_thi_sinh)/count_toan_quoc), " năm 2019 (dựa trên thứ tự xếp hạng trên toàn quốc là ", round(sort_toan_quoc.index(diem_cua_thi_sinh)/count_toan_quoc*100, 2), "%")
except:
